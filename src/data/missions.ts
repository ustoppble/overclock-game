...
export const MISSIONS: SquadMission[] = [
  {
    ...
    intro: 'GINÁSIO CINEMA SITE! "Rouba o DNA. Entrega a catedral." Template de IA não passa desta porta.',
    ...
    phases: [
      ...
      { id: 'p3', name: 'Styleboard — a Alma do Site', domain: 'ux', hp: 80, wave: 2 },
  ...
  },
  {
    ...
    phases: [
      ...
      { id: 'p5', name: 'Integrador liga as Pontas', domain: 'debug', hp: 90, wave: 3 },
  ...
  },
  {
    ...
    phases: [
      ...
      { id: 'p5', name: 'Fix + Re-audit Cirúrgico', domain: 'debug', hp: 110, wave: 3 },
  ...
  },
  {
    ...
    phases: [
      { id: 'p1', name: 'Mecânica + Ref de Gênero', domain: 'ux', dense: true, hp: 120, wave: 1 },
      ...
      { id: 'p5', name: 'Bot Playtest (grava vídeo)', domain: 'qa', hp: 100, wave: 3 },
